...
public abstract class InteractWithEntityListener implements PacketListener {
     ...
     * @return Whether to allow original event (<code>true</code>) or not
     *         (<code>false</code>)
     */
    ...
    public final ListeningWhitelist getReceivingWhitelist() {
        ...
        return ListeningWhitelist.newBuilder().priority(getPriority()).types(PacketType.Play.Client.USE_ENTITY).build();
